...
namespace TheGame
{
    ...
    public class GameplayScreen : GameScreen
    {
        ...
        IWorld world1, world2;
        //MainCharacter germi;
        public Texture2D fireBallTexture;
        private IWorld currentWorld;
        //public Germi getGermi() { return germi; }
        public IWorld getCurrentWorld() { return currentWorld; }
        ...
        public override void LoadContent()
        {
            ...
            world2.LoadContent(content);
            MainCharacter.Instance.LoadContent(content);
        ...
        // Pask
        KeyboardState keyCurrent = new KeyboardState();
                                                       ...
                                                       bool coveredByOtherScreen)
        {
            ...
            if (IsActive)
            {
                ...
                currentWorld.UpdateWorld(gameTime, keyCurrent);
            }
        }
        ...
        {
            if (getCurrentWorld().ID == Germi.Util.WorldID.WORLD1) 
            {
                currentWorld = world2;
            }
        }
