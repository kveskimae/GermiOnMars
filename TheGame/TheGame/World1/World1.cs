...
namespace Germi.World1
{
    ...
    public class World1 : AbstractWorld
    {
        ...
        public World1(GameplayScreen gameplayScreen)
            : base(gameplayScreen, new Vector2(0, 0), "Tagataust", WorldID.WORLD1)
        {
            getTiles()[0][0] = new Tile_w1_r0_c0(gameplayScreen, this);
            getTiles()[0][1] = new Tile_w1_r0_c1(gameplayScreen, this);
            getTiles()[0][2] = new Tile_w1_r0_c2(gameplayScreen, this);

            getTiles()[1][0] = new Tile_w1_r1_c0(gameplayScreen, this);
            getTiles()[1][1] = new Tile_w1_r1_c1(gameplayScreen, this);
            getTiles()[1][2] = new Tile_w1_r1_c2(gameplayScreen, this);

            getTiles()[2][0] = new Tile_w1_r2_c0(gameplayScreen, this);
            getTiles()[2][1] = new Tile_w1_r2_c1(gameplayScreen, this);
            getTiles()[2][2] = new Tile_w1_r2_c2(gameplayScreen, this);
