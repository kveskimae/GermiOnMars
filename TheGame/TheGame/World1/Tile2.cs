...
{
    public class Tile_w1_r1_c1 : AbstractTile
    {
        private GameplayScreen _gameplayScreen;

        public Tile_w1_r1_c1(GameplayScreen gameplayScreen, IWorld world)
        ...
        public override void initObjects()
        {
            ...
            */
            ...
            worldObjects.Add(new Door(_gameplayScreen, World1.DoorLocationTop, DoorPlacement.SCREEN_TOP, 0, 1));
            // worldObjects.Add(new Door(_gameplayScreen, new Vector2(350, 505), DoorPlacement.SCREEN_BOTTOM));
            Door door1 = new Door(_gameplayScreen, World1.DoorLocationLeft, DoorPlacement.SCREEN_LEFT, 1, 0);
            Door door2 = new Door(_gameplayScreen, World1.DoorLocationRight, DoorPlacement.SCREEN_RIGHT, 1, 2);
            ...
            worldObjects.Add(new Stairway(_gameplayScreen, new Vector2(450, 300)));
