...
{
    public class Tile_w1_r1_c2 : AbstractTile
    {

        private GameplayScreen _gameplayScreen;

        public Tile_w1_r1_c2(GameplayScreen gameplayScreen, IWorld world)
        ...
        public override void initObjects()
        {
            ...
            Door door1 = new Door(_gameplayScreen,World1.DoorLocationLeft, DoorPlacement.SCREEN_LEFT, 1, 1);
