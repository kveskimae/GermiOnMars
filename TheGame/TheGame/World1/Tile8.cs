...
{
    public class Tile_w1_r2_c1 : AbstractTile
    {
        private GameplayScreen _gameplayScreen;
        public Tile_w1_r2_c1(GameplayScreen gameplayScreen, IWorld world)
        ...
        public override void initObjects()
        {
            ...
            Door door1 = new Door(_gameplayScreen, World1.DoorLocationRight, DoorPlacement.SCREEN_RIGHT, 2, 2);
            Door door2 = new Door(_gameplayScreen, World1.DoorLocationLeft, DoorPlacement.SCREEN_LEFT, 2, 0);
