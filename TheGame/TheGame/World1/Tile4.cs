...
{
    public class Tile_w1_r0_c0 : AbstractTile
    {
        private GameplayScreen _gameplayScreen;
        public Tile_w1_r0_c0(GameplayScreen gameplayScreen, IWorld world)
        ...
        public override void initObjects()
        {
            ...
            Door door1 = new Door(_gameplayScreen, World1.DoorLocationBottom, DoorPlacement.SCREEN_BOTTOM, 1, 0);
            Door door2 = new Door(_gameplayScreen, World1.DoorLocationRight, DoorPlacement.SCREEN_RIGHT, 0, 1);
