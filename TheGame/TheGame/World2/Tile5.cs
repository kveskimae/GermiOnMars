...
{
    public class Tile_w2_r0_c1 : AbstractTile
    {
        private GameplayScreen _gameplayScreen;
        public Tile_w2_r0_c1(GameplayScreen gameplayScreen, IWorld world)
        ...
        public override void initObjects()
        {
            ...
            worldObjects.Add(new Door(_gameplayScreen,World2.DoorLocationBottom, DoorPlacement.SCREEN_BOTTOM, 1,1));
            
            Door door1 = new Door(_gameplayScreen, World2.DoorLocationLeft, DoorPlacement.SCREEN_LEFT, 0, 0);
            Door door2 = new Door(_gameplayScreen, World2.DoorLocationRight, DoorPlacement.SCREEN_RIGHT, 0, 2);
