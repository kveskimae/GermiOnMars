...
{
    public class Tile_w2_r2_c0 : AbstractTile
    {
        private GameplayScreen _gameplayScreen;
        public Tile_w2_r2_c0(GameplayScreen gameplayScreen, IWorld world)
        ...
        public override void initObjects()
        {
            ...
            Door door1 = new Door(_gameplayScreen, World2.DoorLocationTop, DoorPlacement.SCREEN_TOP, 1, 0);
            Door door2 = new Door(_gameplayScreen, World2.DoorLocationRight, DoorPlacement.SCREEN_RIGHT, 2, 1);
